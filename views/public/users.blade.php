				...
				<div class="card">
					<div class="card-header d-sm-flex d-block">
						<div class="mr-auto mb-sm-0 mb-3">
							<h4 class="card-title mb-2">Users Listing</h4>
						</div>
							...
							<table class="table style-1" id="ListDatatableView">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="media style-1">
												...
												<span class="icon-name mr-2 bgl-success text-danger">JD</span>
									...
									<tr>
										...
										<td>
											<div class="media style-1">
												<span class="icon-name mr-2 bgl-success text-warning">m</span>
												<div class="media-body">
													<h6>Martin Chuaks</h6>
									...
									<tr>
										...
										<td>
											<div class="media style-1">
												<span class="icon-name mr-2 bgl-success text-success">OJ</span>
												<div class="media-body">
													<h6>Oliver Jean</h6>
									...
									<tr>
										...
										<td>
											<div class="media style-1">
												<span class="icon-name mr-2 bgl-success text-success">JD</span>
												<div class="media-body">
													<h6>John Doe</h6>
													<span>johndoe@gmail.com</span>
												</div>
									...
									<tr>
										...
										<td>
											<div class="media style-1">
												<img src="/assets/img/favicon.png" class="img-fluid mr-2" alt="">
												<div class="media-body">
													<h6>Kevin Mandala</h6>
