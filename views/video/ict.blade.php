...
<html lang="en">
	...
	<body>
		...
		<div class="wrapper">
			<iframe src="http://camara.portal/upload/video/ict/player.html" id="myFrame" onload="log_app_visit()" sandbox="allow-same-origin allow-scripts allow-popups allow-forms">
			</iframe>
		</div>
